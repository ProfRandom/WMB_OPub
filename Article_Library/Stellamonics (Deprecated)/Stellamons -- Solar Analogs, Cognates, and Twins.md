...
- **Temperature:**
	- Within a very narrow range, typically $\pm10$ K of the Sun's temperature — $5790$ K (**G2.1V**) to $5810$ K (**G1.9V**).
	- Some definitions are even stricter, within $\pm5$ K — $5795$ K (**G2.05V**) to $5805$ K (**G1.95V**).
- **Age**:
	- **$4.3$ – $4.7$ Gyr** (The Sun's age $\pm200$ Ma)
 - Sometimes as tight as **$\pm100$ Ma**, i.e., $**4.4$ – $4.6$  Gyr**
...
**Solar Analogs**:
- Stars whose *perannual orbits* fall within $(0.500 \cdot\cdot\; 4.850)$ AU, spanning from [[02. Orbits, Thermozones, and Animozones|Zone₀ — Zone₅]] ($Z_0 – Z_5$) and spectral types **F2** – **K9**.
- 
**Solar Cognates**:
- Stars whose *perannual orbits* fall within $(0.750 ·· 1.770)$ AU, spanning from [[02. Orbits, Thermozones, and Animozones|Zone₁ — Zone₄]] ($Z_1 – Z_4$) and spectral types spectral types **F7.62** – **K1.11**.
- 
**Solar Twins**:
- Stars whose *perannual orbits* fall within $(0.950 ·· 1.385)$ AU, spanning from [[02. Orbits, Thermozones, and Animozones|Zone₃ — Zone₄]] ($Z_1 – Z_4$) and spectral types **G1.04** – **G7.73**.
