...
Peromons complete the mononic mass spectrum: the final extreme for independently self-coherent bodies. Larger cosmic masses—clusters, nebulae, galaxies—are vastly more massive, but they are _aggregate systems_, not discrete monons. Synomons define the opposite end of the spectrum, where cohesion is chemical or mechanical rather than gravitational.

# Summary
Together, synomons → duromons → transomons → fusomons → peromons form the complete **Mononic Mass Spectrum**, from chemically-coherent rubble to relativistic collapse objects.