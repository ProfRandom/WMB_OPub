...
**Parameter Notes**:
- **Mass (t):** from sublunar pebbles to brown dwarf threshold. 
- **Density (t):** from hydrogen-ice slushes to ultra dense crystal-metallic cores. 
- **Gravity (t):** ~0.02 t (Mars-like) up to ~60 t (felt at inner gas dwarf surfaces). 
...
- **Radius (t):** up to 11 t to accommodate inflation-limited gas giants and Super-Jupiters.
	- Frequently exceeded by puffy planemons due to close proximity to their stars inflating their atmospheres.
- **Escape Velocity (t):** capped at 25t ≈ 280 km/s, brushing the domain of hot-start brown dwarfs.
