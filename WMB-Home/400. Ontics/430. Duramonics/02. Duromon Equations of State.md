...
The Duramon Equations of State can be arranged into a fully symmetric algebraic network: any two parameters determine the other three. This is mathematically true and occasionally useful — especially for inversion problems or exotic boundary cases.

However, **physical causality is not symmetric**.

WMB treats duramonic properties as a *directed hierarchy* with a strict upstream–downstream dependency:
...
Thus, while the full symmetric table of identities is correct and useful as a reference, the **recommended workflow** for all duramonic modeling is:
