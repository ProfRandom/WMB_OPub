...
- $þ$ = the thermal interval constant (see next heading) for the relevant spectral class
...
Let us say that Essem has a near neighbor, $Essel$, and we know that its relative temperature is $\Theta = 0.876\,s$.  What is its spectral type?
...
**Essel's spectral type is $G9.192$**; (A [[08. Solar Analogs, Cognates, and Twins|solar cognate.]])
