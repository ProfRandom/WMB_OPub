...
- **Temperature** — How hot is the surface?
	...
	- Relative measure: Solar units ($\Theta$)
...
## Converting Between Absolute Kelvin ($K$) And Solar Relative ($\Theta$)
...
Let us say that Essem has a near neighbor, Essel, and we know that its relative temperature is $T = 0.876s$.  What is its spectral type?
